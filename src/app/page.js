  ...
  const features = [
    {
      ...
      description:
        "Transform complex data into actionable insights with our intuitive analytics platform.",
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Stay One Step Ahead",
      description:
        "Leverage predictive analytics to anticipate trends and make proactive decisions.",
    },
    {
      icon: <Database className="w-6 h-6" />,
      title: "Centralize SQL Queries",
      description:
        "Manage all your database queries in one unified platform with version control.",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Visualize with Charts",
      description:
        "Create stunning visualizations that make your data story come alive.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 text-white">
      ...
      <nav className="backdrop-blur-md bg-white/10 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-6 items-center">
            ...
            <Link href="#testimonials" className="hover:text-blue-300 transition">
              Testimonials
            </Link>
            <button
              className="px-6 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg transition-all transform hover:scale-105"
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          A SQL you love. Simple in the moment, powerful in the long run. Start
          analyzing your data in seconds.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto mb-12">
          ...
          />
          <button
            className="w-full sm:w-auto px-8 py-3 bg-blue-500 hover:bg-blue-600 rounded-lg font-semibold transition-all transform hover:scale-105 flex items-center justify-center gap-2 whitespace-nowrap"
            onClick={() => router.push("/dashboard")}
          >
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <div className="backdrop-blur-lg bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-white/20 rounded-3xl p-12">
          ...
          <button
            className="px-10 py-4 bg-blue-500 hover:bg-blue-600 rounded-lg font-semibold text-lg transition-all transform hover:scale-105 flex items-center justify-center gap-2 mx-auto"
            onClick={() => router.push("/dashboard")}
          >
